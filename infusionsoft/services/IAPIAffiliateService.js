module.exports = IAPIAffiliateService = require('typedef')
...
// APIAPIAffiliateService is used to pull commission data and activities for
...
// APIAPIAffiliateService mirror the reports produced inside Infusionsoft. To manage
// affiliate information (ie Name, Phone, etc.) you will need to use the
// DataService.
.interface('IAPIAffiliateService') .define({
